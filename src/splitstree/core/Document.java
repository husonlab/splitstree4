...
import splitstree.algorithms.additional.GreedyCompatible;
import splitstree.algorithms.additional.GreedyWC;
import splitstree.algorithms.additional.LeastSquaresWeights;
import splitstree.algorithms.characters.*;
import splitstree.algorithms.distances.*;
import splitstree.algorithms.quartets.Quartets2Splits;
import splitstree.algorithms.quartets.QuartetsTransform;
import splitstree.algorithms.reticulate.Reticulate2Network;
import splitstree.algorithms.reticulate.ReticulateTransform;
import splitstree.algorithms.splits.Splits2Network;
import splitstree.algorithms.splits.SplitsTransform;
import splitstree.algorithms.trees.Trees2Network;
import splitstree.algorithms.trees.Trees2Splits;
import splitstree.algorithms.trees.TreesTransform;
import splitstree.algorithms.unaligned.*;
import splitstree.algorithms.util.Configurator;
import splitstree.algorithms.util.MultiGeneAnalysis;
import splitstree.algorithms.util.Transforms;
import splitstree.algorithms.util.simulate.SimulationExperiments;
