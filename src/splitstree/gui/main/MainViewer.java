...
import splitstree.gui.undo.UndoableEdgeLabelSearcher;
import splitstree.gui.undo.UndoableNodeLabelSearcher;
...
public class MainViewer extends PhyloGraphView implements IDirectableViewer, IMainViewer {
    ...
    public MainViewer(final Director dir0) {
        ...
        setGraphViewListener(new splitstree.gui.main.GraphViewListener(this));
