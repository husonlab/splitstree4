...
import splitstree.gui.main.StatusBar;
...
//viewer.removeEdgeActionListener(eal);
    ...
    private JTabbedPane getPane() {
        ...
        pane.add("Internet", getInternetPanel());
        return pane;
    }
...
*/
    ...
    JTextField proxyAdress, proxyPort, proxyUserName, proxyUserPassword;
    JRadioButton useProxy, useUser;
    JLabel proxyAdressLabel, proxyPortLabel, proxyUserNameLabel, proxyUserPasswordLabel;

    /**
     * Tap for internet settings (Proxy)
     *
     * @return
     */
    private JPanel getInternetPanel() {
        GridBagLayout gridBag = new GridBagLayout();
        JPanel pan = new JPanel(gridBag);
        GridBagConstraints c = new GridBagConstraints();
        c.insets = new Insets(1, 7, 1, 5);
        ...
        c.gridwidth = 1;//2;
        c.gridheight = 1;
        proxyAdressLabel = new JLabel("HTTP-Proxy: ");
        pan.add(proxyAdressLabel, c);

        proxyAdress = new JTextField();
        c.anchor = GridBagConstraints.WEST;
        c.weightx = 1;
        c.weighty = 1;
        c.gridx = 1;
        ...
        c.gridwidth = 1;//2;
        c.gridheight = 1;
        proxyUserPasswordLabel = new JLabel("Password : ");
        pan.add(proxyUserPasswordLabel, c);

        proxyUserPassword = new JTextField();
        c.weightx = 1;
        c.weighty = 1;
        c.gridx = 1;
        c.gridy = 5;
        c.gridwidth = 2;
        c.gridheight = 1;
        pan.add(proxyUserPassword, c);

        // add select buttons

        useUser = new JRadioButton(actions.getUseProxyUser(proxyUserName, proxyUserPassword, proxyUserNameLabel, proxyUserPasswordLabel));
        c.anchor = GridBagConstraints.WEST;
        c.weightx = 1;
        c.weighty = 1;
        c.gridx = 0;
        ...
        useProxy = new JRadioButton(actions.getUseProxy(useUser, proxyAdress, proxyPort, proxyUserName, proxyUserPassword, proxyAdressLabel, proxyPortLabel, proxyUserNameLabel, proxyUserPasswordLabel));
        c.anchor = GridBagConstraints.WEST;
        c.weightx = 1;
        c.weighty = 1;
        c.gridx = 0;
        ...
        useProxy.setSelected(ProgramProperties.get("useProxy", false));
        useUser.setSelected(ProgramProperties.get("useProxyUser", false));
        proxyAdress.setText(ProgramProperties.get("proxyAdress", ""));
        proxyPort.setText(ProgramProperties.get("proxyPort", ""));
        proxyUserName.setText(ProgramProperties.get("proxyUserName", ""));
        proxyUserPassword.setText(ProgramProperties.get("proxyUserPassword", ""));
        ...
        JButton defaultInternet = new JButton(getActions().getDefaultInternet(useProxy, useUser, proxyAdress, proxyPort, proxyUserName, proxyUserPassword));
        c.fill = GridBagConstraints.HORIZONTAL;
        c.weightx = 1;
        c.weighty = 0;
        c.gridx = 0;
        ...
        c.gridheight = GridBagConstraints.REMAINDER;
        c.gridwidth = 1;
        pan.add(defaultInternet, c);

        JButton applyInternet = new JButton(getActions().getApplyInternet(useProxy, useUser, proxyAdress, proxyPort, proxyUserName, proxyUserPassword));
        c.fill = GridBagConstraints.HORIZONTAL;
        c.weightx = 1;
        c.weighty = 0;
        c.gridx = 1;
        ...
        c.gridheight = GridBagConstraints.REMAINDER;
        c.gridwidth = 1;
        pan.add(applyInternet, c);

        JButton oKGraph = new JButton(getActions().getOKInternet(useProxy, useUser, proxyAdress, proxyPort, proxyUserName, proxyUserPassword));
        c.weightx = 1;
        c.weighty = 0;
        c.gridx = 2;
        c.gridy = 6;
