...
import splitstree.algorithms.util.simulate.RandomCharacters;
   ...
   */
    ...
    public void read(NexusStreamParser np, Taxa taxa, Characters characters,
        ...
        if (np.peekMatchIgnoreCase("FORMAT")) {
            ...
            getFormat().showSplits = np.findIgnoreCase(tokens, "splitstree", true, getFormat().showSplits);
    ...
    public boolean getFormatSwitchValue(String name) {
        ...
        else if (name.equalsIgnoreCase("splitstree"))
