/*
 * C2Qext.java Copyright (C) 2022 Daniel H. Huson
 *
 ...
 */
public class C2Qext /* implements Characters2Quartets */ {
     ...
     */
    public Quartets apply(Document doc, Taxa taxa, Characters chars) throws Exception {
        {
            ...
            File infile = File.createTempFile("c2q", ".in");
            infile.deleteOnExit();
            File outfile = File.createTempFile("c2q", ".out");
