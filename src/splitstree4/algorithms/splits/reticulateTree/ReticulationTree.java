/*
 * ReticulationTree.java Copyright (C) 2022 Daniel H. Huson
 *
...
public class ReticulationTree implements Comparator {
    ...
    public HashSet getReticulation2Splits(int reticulation, int positionCovered) {
        if (reticulation2splits[reticulation][positionCovered - 1] == null)
            reticulation2splits[reticulation][positionCovered - 1] = new HashSet();
