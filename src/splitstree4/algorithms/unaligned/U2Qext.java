/*
 * U2Qext.java Copyright (C) 2022 Daniel H. Huson
 *
 ...
 */
public class U2Qext /* implements Unaligned2Quartets */ {
     ...
     *
     * @param taxa    the taxa
     * @param unalign the unaligned matrix
     ...
     *
     * @param taxa    the taxa
     * @param unalign the input characters
     * @return the computed quartets Object
     */
    public Quartets apply(Document doc, Taxa taxa, Unaligned unalign) throws Exception {
        {
            ...
            File infile = File.createTempFile("u2q", ".in");
            infile.deleteOnExit();
            File outfile = File.createTempFile("u2q", ".out");
