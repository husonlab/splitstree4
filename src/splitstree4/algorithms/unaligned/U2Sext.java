/*
 * U2Sext.java Copyright (C) 2022 Daniel H. Huson
 *
...
public class U2Sext /* implements Unaligned2Splits */ {
     ...
     *
     * @param taxa    the taxa
     * @param unalign the input unaligned
     * @return the computed splits Object
     */
    public Splits apply(Document doc, Taxa taxa, Unaligned unalign) throws Exception {
        {
            ...
            File infile = File.createTempFile("u2s", ".in");
            infile.deleteOnExit();
            File outfile = File.createTempFile("u2s", ".out");
