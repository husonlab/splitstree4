...
public class Transforms {
	private static final Map<String, Transformation> name2trans = new HashMap<>();
	private static final Map<Transformation, String> trans2inputBlock = new HashMap<>();
	private static final Map<Transformation, String> trans2outputBlock = new HashMap<>();
    ...
    private static void setInputOutputBlocks(String fullName, Transformation trans) {
		...
		String[] names = Document.getListOfBlockNames().toArray(new String[0]);
