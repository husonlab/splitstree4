/*
 * PhiTest.java Copyright (C) 2022 Daniel H. Huson
 *
...
import splitstree4.util.ErrorFunction;
...
public class PhiTest implements CharactersAnalysisMethod {
    ...
    private int pair_score(int char_a, int char_b) {
        ...
        int char_a_states = nstates[char_a];
        int char_b_states = nstates[char_b];
    ...
    double approxPhi(Characters characters) {
    ...
    public void findBlocks(Characters characters, int numBreakPoints) {
     ...
     */
    public String apply(Document doc, Taxa taxa, Characters block) {
        return apply(doc);
    }
