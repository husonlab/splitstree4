/*
 * ResetTransformCommand.java Copyright (C) 2022 Daniel H. Huson
 *
...
/**
 * reset the graph transform command
...
public class ResetTransformCommand extends ICommandAdapter implements ICommand {
    ...
    public ICommand execute() {
        setReverseCommand(new TransformCommand(viewer, viewer.trans, viewer.trans));
