/*
 * HybridTreesGenerator.java Copyright (C) 2022 Daniel H. Huson
 *
...
public class HybridTreesGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        splitstree4.externalIO.imports.NewickTree newick = new splitstree4.externalIO.imports.NewickTree();
